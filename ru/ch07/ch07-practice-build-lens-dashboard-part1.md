...
На данный момент мы завершили анализ базового обзора протокола Lens, профиля создателя и информации о доменном имени, а также добавили функцию поиска по доменным именам. В предыдущем разделе "Основные анализируемые данные канбан-доски" мы перечислили больше контента, который можно анализировать. Во второй части этого руководства мы продолжим анализ публикаций, внимания, избранного, NFT и других аспектов, выпущенных создателем. Вы также можете исследовать и создавать собственные запросы.

## Домашнее задание

Пожалуйста, объедините содержание учебного пособия, чтобы создать собственную панель мониторинга данных протокола Lens, и попробуйте новый анализ запросов, ссылаясь на содержание, указанное в "Основном аналитическом контенте панели мониторинга данных". Активно практикуйтесь, создавайте панели мониторинга данных и делитесь ими с сообществом. Мы будем регистрировать выполнение и качество домашнего задания, а затем задним числом предоставим определенные награды для всех, включая, но не ограничиваясь, идентификацией сообщества Dune, периферийными объектами, бесплатной квотой API, POAP, различными членами кооперативных продуктов данных, рекомендациями по вакансиям в области анализа данных блокчейна, приоритетной квалификацией для регистрации на мероприятия сообщества в автономном режиме и другими стимулами сообщества Sixdegree и т. д.

## О Нас

`Sixdegree` – это профессиональная команда по анализу данных на блокчейне. Наша миссия – предоставлять пользователям точные графики, аналитику и инсайты на основе данных на блокчейне. Мы стремимся популяризировать анализ данных на блокчейне. Благодаря созданию сообщества и написанию учебных пособий, среди прочих инициатив, мы обучаем аналитиков данных на блокчейне, публикуем ценный аналитический контент, продвигаем сообщество для создания слоя данных блокчейна и воспитываем таланты для широкого будущего блокчейн-данных. Добро пожаловать на площадку обмена опытом!
