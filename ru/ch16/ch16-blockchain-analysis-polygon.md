...
Выше мы провели предварительный анализ сети Polygon с нескольких аспектов, включая блоки, потребление газа, транзакции, пользователей, нативные токены и смарт-контракты. С помощью этой панели инструментов мы можем получить общее представление о сети Polygon. В частности, благодаря анализу наиболее популярных смарт-контрактов, мы можем выявить популярные проекты. Это позволяет нам выбирать конкретные проекты, представляющие интерес, для дальнейшего анализа.

На данный момент SixdegreeLab завершила обзоры для нескольких блокчейнов, которые можно найти здесь:

* [Серия обзоров блокчейнов](https://dune.com/sixdegree/blockchain-overview-series)<a id="jump_8"></a>
## О нас

`Sixdegree` — это профессиональная команда по анализу данных на блокчейне. Наша миссия — предоставлять пользователям точные графики, аналитику и инсайты на основе данных блокчейна. Мы стремимся популяризировать анализ данных на блокчейне. Благодаря созданию сообщества, написанию учебных пособий и другим инициативам, мы обучаем аналитиков данных блокчейна, выпускаем ценный аналитический контент, продвигаем сообщество для построения слоя данных блокчейна и воспитываем таланты для широкого будущего приложений данных блокчейна. Добро пожаловать на площадку обмена опытом в сообществе!
