...
С этим мы завершили создание первой панели мониторинга данных Dune. Полный интерфейс этой панели мониторинга выглядит как показано на следующем изображении:

![](img/ch03_dashboard.png)

Чтобы избежать подавляющей сложности, мы охватили только некоторые основные запросы, и, как следствие, графики на панели мониторинга могут не выглядеть чрезвычайно сложными. Однако это не имеет большого значения. Гораздо важнее, чтобы вы могли использовать этот учебник в качестве отправной точки для начала собственного путешествия в области анализа данных Onchain.
После прочтения этого учебника я надеюсь, что вы попробуете это на практике. Uniswap был всего лишь одним примером DEX, и вы можете проводить подобные анализы на любой другой DEX на разных цепочках. Комбинируя техники из предыдущих уроков, вы можете исследовать и сравнивать данные других DEX или даже той же DEX на разных цепочках (например, UniSwap на Ethereum и Optimism). Как аналитик данных блокчейна, ваша панель мониторинга - это ваше резюме, так что отнеситесь к ней серьезно!

## Домашнее задание

Основываясь на содержании учебного пособия, создайте информационную панель с не менее чем 5 запросами для любой DEX. Формат наименования для панели должен быть "SixdegreeAssignment1-ВашеИмя", например "SixdegreeAssignment1-Spring". Этот формат упрощает возможность обучения друг у друга и помогает нам контролировать качество учебных пособий. Чтобы стимулировать активное участие в создании информационных панелей, мы будем вести учет выполнения и качества домашних заданий. В будущем мы будем предоставлять вознаграждения, включая, но не ограничиваясь ими, идентификаторы сообщества Dune, физические товары, бесплатные квоты API, POAP, членство в различных совместных данных продуктах, рекомендации по работе для анализа данных блокчейна, приоритетная регистрация на мероприятия сообщества в автономном режиме и другие стимулы от сообщества Sixdegree.

Продолжайте в том же духе! Не стесняйтесь делиться ссылками на свои информационные панели в группе Dune WeChat или канале Discord Dune.
## О нас

`Sixdegree` — это профессиональная команда аналитиков данных на блокчейне. Наша миссия — предоставлять пользователям точные графики, анализ и инсайты на основе данных с блокчейна. Мы стремимся популяризировать анализ данных на блокчейне. Благодаря созданию сообщества и написанию обучающих материалов, а также другим инициативам, мы обучаем аналитиков данных на блокчейне, создаем ценный аналитический контент, продвигаем сообщество для построения слоя данных блокчейна и воспитываем таланты для широкого будущего приложений данных блокчейна. Добро пожаловать на площадку обмена опытом!
